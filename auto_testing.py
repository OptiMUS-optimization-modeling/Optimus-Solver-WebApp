...
from auto_testing_helper_functions.auto_testing_helper_functions_gurobipy import synthesize_code_cvxpy, execute_and_debug
...
def check_solution(dir):
   ...
   if abs(solution - expected_solution['objective']) <= abs(expected_solution['objective']) * 0.1:
      return True
   else:
      return False
...
### Main
SOLVER = "gurobipy"
TESTPATH = "/Users/gaowenzhi/Desktop/optimus-OR-paper/data/new_dataset/sample_datasets"
   ...
   for i in range(1, 251):
      ...
      try:
         ...
         try: 
            ...
            # Write output
            with open(os.path.join(dir, 'test_results', 'optimus_log.txt'), 'w') as f:
               f.write(output)
